...
and provisioning attaches it for you. One plan is plenty: a review runs on the order of a Claude Code session, so
a single Codex plan covers a busy repo without trouble.
